...
function sayWord16() {
  var msg = new SpeechSynthesisUtterance('do');
  msg.lang = 'en-US';
  speechSynthesis.speak(msg);
}
function sayWord17() {
...
function sayWord27() {
  var msg = new SpeechSynthesisUtterance('in');
  msg.lang = 'en-US';
  speechSynthesis.speak(msg);
}
function sayWord28() {
         ...
         <center>
            <table>
               <tbody>
                  <tr>
                     <td>
                        <button onClick={sayWord1} tabIndex="1">
                        <img src={like}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord2} tabIndex="2">
                        <img src={want}/>
                        </button>
                     </td>
                  </tr>
                  <tr>
                     <td>
                        <button onClick={sayWord3} tabIndex="3">
                        <img src={not}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord4} tabIndex="4">
                        <img src={go}/>
                        </button>
                     </td>
                  </tr>
            ...
            <table>
               <tbody>
                  <tr>
                     ...
                     <td>
                        <button onClick={sayWord5} tabIndex="3">
                        <img src={get}/>
                        </button>
                     </td>
                  </tr>
                  <tr>
                     <td>
                        <button onClick={sayWord3} tabIndex="4">
                        <img src={not}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord4} tabIndex="5">
                        <img src={go}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord6} tabIndex="6">
                        <img src={look}/>
                        </button>
                     </td>
                  </tr>
                  <tr>
                     <td>
                        <button onClick={sayWord7} tabIndex="7">
                        <img src={I1}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord8} tabIndex="8">
                        <img src={he}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord9} tabIndex="10">
                        <img src={open}/>
                        </button>
                     </td>
                  </tr>
         ...
         <center>
            <table>
               <tbody>
                  <tr>
                     <td>
                        <button onClick={sayWord1}>
                        <img src={like}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord2}>
                        <img src={want}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord5}>
                        <img src={get}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord10}>
                        <img src={make}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord11}>
                        <img src={good}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord12}>
                        <img src={more}/>
                        </button>
                     </td>
                  </tr>
                  <tr>
                     <td>
                        <button onClick={sayWord3}>
                        <img src={not}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord4}>
                        <img src={go}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord6}>
                        <img src={look}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord13}>
                        <img src={turn}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord14}>
                        <img src={help}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord15}>
                        <img src={different}/>
                        </button>
                     </td>
                  </tr>
                  <tr>
                     <td>
                        <button onClick={sayWord7}>
                        <img src={I1}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord8}>
                        <img src={he}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord9}>
                        <img src={open}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord16}>
                        <img src={do1}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord17}>
                        <img src={put}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord18}>
                        <img src={same}/>
                        </button>
                     </td>
                  </tr>
                  <tr>
                     <td>
                        <button onClick={sayWord19}>
                        <img src={you}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord20}>
                        <img src={she}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord21}>
                        <img src={that}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord22}>
                        <img src={up}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord23}>
                        <img src={all}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord24}>
                        <img src={some}/>
                        </button>
                     </td>
                  </tr>
                  <tr>
                     <td>
                        <button onClick={sayWord25}>
                        <img src={it}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord26}>
                        <img src={here}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord27}>
                        <img src={in1}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord28}>
                        <img src={on}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord29}>
                        <img src={can}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord30}>
                        <img src={finish}/>
                        </button>
                     </td>
                  </tr>
                  <tr>
                     <td>
                        <button onClick={sayWord31}>
                        <img src={where}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord32}>
                        <img src={what}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord33}>
                        <img src={why}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord34}>
                        <img src={who}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord35}>
                        <img src={when}/>
                        </button>
                     </td>
                     <td>
                        <button onClick={sayWord36}>
                        <img src={stop}/>
                        </button>
                     </td>
                  </tr>
